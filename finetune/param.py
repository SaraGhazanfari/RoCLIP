...
parser.add_argument('--vision_weight', type=float, default=0.9, help='Weight for clean loss')
...
# distributed setting
parser.add_argument("--ncpus", type=int, default=48, help="Number of CPUS per GPU.")
