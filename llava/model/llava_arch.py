...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
            ...
            images, image_sizes=None, config=None):
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            cur_new_input_embeds = [x.to(cur_input_embeds.device) for x in cur_new_input_embeds]
        ...
        print(config)
        tokenizer_model_max_length = None if not config else config.tokenizer_model_max_length
    ...
    #             cur_image_features = image_features[cur_image_idx] if image_features.shape[
    #                                                                       0] > 1 else image_features.squeeze(0)
    #             # cur_image_features = image_features[cur_image_idx]
